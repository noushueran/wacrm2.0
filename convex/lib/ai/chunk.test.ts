...
// Port of `src/lib/ai/chunk.test.ts` 1:1 — `chunkText` is pure, so its
// tests carry over unchanged (only the quote style/semicolons match
// this codebase's `convex/` convention).
