// ============================================================
// Knowledge-base chunking. Convex port of `src/lib/ai/chunk.ts` — pure
// logic, copied verbatim (only the quote style changed, to this
// codebase's `convex/` double-quote convention) since chunking has no
// dependency on anything Postgres/Supabase-specific.
//
...
// `convex/aiKnowledge.ts`'s `ingest` action relies on that determinism
// to make re-ingesting the same content idempotent.
// ============================================================
