 ...
 *
 * Convex port of `src/lib/flows/layout.ts` — ported verbatim; its only
 * import is the `@dagrejs/dagre` package, already a project dependency,
 * so no import-path change was needed.
 *
