 ...
 *
 * Convex port of `src/lib/flows/fallback.ts` — ported verbatim, no
 * changes at all (the sole import, `./types`, resolves to this same
 * directory's `types.ts` both before and after the port).
 *
