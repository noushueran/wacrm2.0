 ...
 *
 * Convex port of `src/lib/flows/validate.ts` — ported verbatim except
 * one import path: `INTERACTIVE_LIMITS` comes from the sibling
 * `../whatsapp/metaApi` instead of `@/lib/whatsapp/meta-api`.
 *
 ...
 *      `convex/lib/whatsapp/metaApi.ts` (ported from
...
import { INTERACTIVE_LIMITS } from "../whatsapp/metaApi";
